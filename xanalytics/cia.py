...
for row in data:
    ...
    if rownum == 0:
        ...
        sql_template = 'INSERT INTO cia VALUES ({commas})'
        insert_command = sql_template.format(commas=commas)
    else:
...
if __name__ == '__main__':
    ...
    for row in c.execute(
            "SELECT Internet_country_code, Languages"
            " from cia where GDP_per_capita_PPP < 3000"
    ):
        cc = row[0]
        if len(cc) < 1:
            continue
    ...
    print countries == ['st', 'sh', 'kh', 'et', 'cm', 'bf', 'gh', 'lr',
                        'tz', 'cd', 'ye', 'pk', 'ps', 'in', 'ls', 'ke',
                        'tj', 'af', 'bd', 'er', 'sb', 'ps', 'rw', 'so',
                        'la', 'mw', 'bj', 'eh', 'tg', 'tl', 'cf', 'vn',
                        'ml', 'td', 'tk', 'sn', 'mz', 'ug', 'ne', 'gn',
                        'fm', 'ng', 'tv', 'mh', 'ht', 'sl', 'md', 'gw',
                        'gm', 'uz', 'bi', 'ni', 'mg', 'sd', 'np', 'kp',
                        'zm', 'pg', 'ci', 'zw', 'mr', 'kg', 'mm', 'km']
...
# Land_use_details
# Land_boundaries
# Land_boundaries_details
# Infant_mortality_rate
# Infant_mortality_rate_details
# Industries
# Waterways
# Waterways_details
# Inflation_rate_consumer_prices
# Inflation_rate_consumer_prices_details
# Languages
# Languages_details
# Internet_country_code
# HIV_AIDS_adult_prevalence_rate
# HIV_AIDS_adult_prevalence_rate_details
# HIV_AIDS_people_living_with_HIV_AIDS
# HIV_AIDS_people_living_with_HIV_AIDS_details
# HIV_AIDS_deaths
# HIV_AIDS_deaths_details
# Telephones_main_lines_in_use
# Telephones_main_lines_in_use_details
# Sex_ratio
# Sex_ratio_details
# Internet_users
# Internet_users_details
# Television_broadcast_stations
# Television_broadcast_stations_details
# Geographic_coordinates
# Age_structure
# Age_structure_details
# Radio_broadcast_stations
# Radio_broadcast_stations_details
# GDP_composition_by_sector
# GDP_composition_by_sector_details
# Disputes_international
# Area
# Area_details
# Irrigated_land
# Irrigated_land_details
# Map_references
# Location
# Country_name
# Coastline
# Coastline_details
# Imports_partners
# Imports_partners_details
# Constitution
# Diplomatic_representation_in_the_US
# Manpower_reaching_militarily_significant_age_annually
# Manpower_reaching_militarily_significant_age_annually_details
# Distribution_of_family_income_Gini_index
# Distribution_of_family_income_Gini_index_details
# Oil_production
# Oil_production_details
# Debt_external
# Debt_external_details
# Exports
# Exports_details
# Oil_exports
# Oil_exports_details
...
# Median_age_details
# Oil_consumption
# Oil_consumption_details
# Oil_imports
# Oil_imports_details
# Oil_proved_reserves
# Oil_proved_reserves_details
# Natural_gas_proved_reserves
# Natural_gas_proved_reserves_details
# Executive_branch
# Exchange_rates
# Exchange_rates_details
# Ethnic_groups
# Ethnic_groups_details
# Market_value_of_publicly_traded_shares
# Market_value_of_publicly_traded_shares_details
# Exports_partners
# Exports_partners_details
# Airports
# Airports_details
# School_life_expectancy_primary_to_tertiary_education
# School_life_expectancy_primary_to_tertiary_education_details
# Population_below_poverty_line
# Population_below_poverty_line_details
# Household_income_or_consumption_by_percentage_share
# Household_income_or_consumption_by_percentage_share_details
# Electricity_exports
# Electricity_exports_details
# Electricity_consumption
# Electricity_consumption_details
# Capital
# Background
...
# Commercial_bank_prime_lending_rate_details
# Death_rate
# Death_rate_details
# Pipelines
# Pipelines_details
# GDP_official_exchange_rate
# GDP_official_exchange_rate_details
# Stock_of_direct_foreign_investment_at_home
# Stock_of_direct_foreign_investment_at_home_details
# Stock_of_direct_foreign_investment_abroad
# Stock_of_direct_foreign_investment_abroad_details
# Administrative_divisions
# Total_renewable_water_resources
# Total_renewable_water_resources_details
# Freshwater_withdrawal_domestic_industrial_agricultural
# Freshwater_withdrawal_domestic_industrial_agricultural_details
# Agriculture_products
# Military_branches
# Birth_rate
# Birth_rate_details
# Education_expenditures
# Education_expenditures_details
# Budget
# Budget_details
# Climate
# Imports_commodities
...
# Natural_resources
# Net_migration_rate
# Net_migration_rate_details
# Geography_note
# Political_pressure_groups_and_leaders
# Economy_overview
# Telephones_mobile_cellular
# Telephones_mobile_cellular_details
# Independence
# Natural_gas_exports
# Natural_gas_exports_details
# Natural_gas_imports
# Natural_gas_imports_details
# Natural_gas_con
